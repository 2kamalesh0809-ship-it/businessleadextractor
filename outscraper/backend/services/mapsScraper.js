...
const generateRunId = () => Math.random().toString(36).substring(2, 15);
 ...
 */
async function scrapeGoogleMaps(keyword, location, limit = 100, socket = null, dummyUserId = null, jobId = null) {
